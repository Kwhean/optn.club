  ...
  <section>
    ...
    <div class="grow">
      ...
      <div class="content">
        ...
        <div class="set-upgrades">
          <EnumSelect
            v-model="form.build.tiresAndRims.rimStyle.front.type"
            label="Front Rims Style"
            :type="RimStyleType"
          />
          <InputControl
            v-model="form.build.tiresAndRims.rimStyle.front.name"
            label="Front Rims Name"
            :disabled="form.build.tiresAndRims.rimStyle.front.type === RimStyleType.stock"
          />
        </div>
        <div class="set-upgrades">
          <EnumSelect
            v-model="form.build.tiresAndRims.rimStyle.rear.type"
            label="Rear Rims Style"
            :type="RimStyleType"
          />
          <InputControl
            v-model="form.build.tiresAndRims.rimStyle.rear.name"
            label="Rear Rims Name"
            :disabled="form.build.tiresAndRims.rimStyle.rear.type === RimStyleType.stock"
          />
        </div>
        <div class="set-upgrades">
          <FrontRearInputs
